...
function getPortfolioData() {
    ...
    const certifications = db.prepare('SELECT certification_name FROM certifications ORDER BY display_order, id').all();
    ...
    return {
        ...
        projects: projects || [],
        certifications: certifications.map(c => c.certification_name) || [],
        languages: languages || []
    };
}
